...
public class CourseController extends BaseController
{
     ...
     * 查询课程信息管理列表
     */
//    @PreAuthorize("@ss.hasPermi('dance:course:list')")
    @GetMapping("/list")
     ...
     * 导出课程信息管理列表
     */
    @PreAuthorize("@ss.hasPermi('dance:course:export')")
     ...
     * 获取课程信息管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('dance:course:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增课程信息管理
     */
    @PreAuthorize("@ss.hasPermi('dance:course:add')")
     ...
     * 修改课程信息管理
     */
    @PreAuthorize("@ss.hasPermi('dance:course:edit')")
     ...
     * 删除课程信息管理
     */
    @PreAuthorize("@ss.hasPermi('dance:course:remove')")
